...
INSERT INTO appusers(id,nombreUsuario,nombreApellido,fechaNacimento,contrasena,url,correoElectronico,authority) VALUES (1,'admin1','$2a$10$nMmTWAhPTqXqLDJTag3prumFrAJpsYtroxf0ojesFYq0k4PmcbWUS',1);

-- Ten player users, named player1 with passwor 0wn3r
INSERT INTO authorities(id,authority) VALUES (2,'PLAYER');
INSERT INTO appusers(id,nombreUsuario,nombreApellido,fechaNacimento,contrasena,url,correoElectronico,authority) VALUES (4,'Carlosbox2k','Carlos Borrego Ortiz','2005-02-04','$2a$10$DaS6KIEfF5CRTFrxIoGc7emY3BpZZ0.fVjwA3NiJ.BjpGNmocaS3e','https://example.com/img/carlos.png', 'carlos@saboteur.es', 2);
INSERT INTO appusers(id,nombreUsuario,nombreApellido,fechaNacimento,contrasena,url,correoElectronico,authority) VALUES (4,'mantecaoHacker','Marcos Ángel Ayala Blanco','2005-03-12','$2a$10$DaS6KIEfF5CRTFrxIoGc7emY3BpZZ0.fVjwA3NiJ.BjpGNmocaS3e','https://example.com/img/marcos.png', 'marcos@saboteur.es', 2);
